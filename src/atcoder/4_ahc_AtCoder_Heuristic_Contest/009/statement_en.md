...
AHC has a new rating system that is different from the existing ABC/ARC/AGC rating system.
	Unlike the ABC/ARC/AGC ratings, AHC rating does not decrease even if contest performance is poor. Please feel free to participate.
...
<li>
For other rules, see <a href="https://atcoder.jp/contests/ahc009/rules">here</a>.
</li>
