...
If you output an illegal cleaning route (length exceeds $10^5$, does not return to $(0,0)$, there is an unvisited square, or it hits a wall), it will be judged as 
<span>
WA
</span>
.
